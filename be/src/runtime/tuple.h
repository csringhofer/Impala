...
class Tuple {
 public:
  ...
  int64_t TotalByteSize(const TupleDescriptor& desc, bool assume_smallify=false) const;
  ...
  /// If 'assume_smallify' is true, calculates with smallified string sizes even for not
  /// (yet) smallified strings.
  int64_t VarlenByteSize(const TupleDescriptor& desc, bool assume_smallify=false) const;
