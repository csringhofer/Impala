...
public class CatalogTest {
  ...
  // Note that this test used to be flaky, so it was removed (6 years ago). I added it
  // again, hoping that the cause of the flakiness no longer exists.
  @Test
  public void testStats() throws CatalogException {
    ...
    assertEquals(idCol.getStats().getAvgSize(),
    ...
    assertEquals(boolCol.getStats().getAvgSize(),
    ...
    assertEquals(tinyintCol.getStats().getAvgSize(),
    ...
    assertEquals(smallintCol.getStats().getAvgSize(),
    ...
    assertEquals(intCol.getStats().getAvgSize(),
        PrimitiveType.INT.getSlotSize(), 0.0001);
    ...
    assertEquals(bigintCol.getStats().getAvgSize(),
    ...
    assertEquals(floatCol.getStats().getAvgSize(),
    ...
    assertEquals(doubleCol.getStats().getAvgSize(),
    ...
    assertEquals(timestampCol.getStats().getAvgSize(),
    ...
    assertTrue(stringCol.getStats().getAvgSize() > 0);
  ...
  private void assertStatsUnknown(Column column) {
    ...
    assertEquals(expectedSize, column.getStats().getAvgSize(), 0.0001);
