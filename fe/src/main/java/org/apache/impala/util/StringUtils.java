...
public abstract class StringUtils {
  ...
  public static ByteBuffer toUtf8Buffer(String str) {
    try {
      return StandardCharsets.UTF_8.newEncoder().encode(CharBuffer.wrap(str));
  ...
  public static byte[] toUtf8Array(String str) {
    ByteBuffer buf = toUtf8Buffer(str);
  ...
  public static String fromUtf8Buffer(ByteBuffer buf, boolean canFail) {
    try {
      ...
      Preconditions.checkState(canFail);
      return null;
    }
  }
